<template>
  <div class="chat-bot-container">
    ...
    >
      <UIcon :name="isChatOpen ? 'i-heroicons-x-mark' : 'i-heroicons-chat-bubble-left-right'" class="text-2xl" />
    </button>
    ...
    >
      <!-- En-tête du chat -->
      <div class="chat-header bg-primary-500 text-white p-4 flex justify-between items-center">
      ...
      <!-- Corps du chat -->
        ...
        <div v-if="isTyping" class="typing-indicator bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 max-w-[100px] rounded-lg p-3 mr-auto">
          <span class="dots">
            <span class="dot"></span>
            <span class="dot"></span>
            <span class="dot"></span>
      ...
      <!-- Pied du chat -->
      <div class="chat-footer p-3 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700">
        <div class="flex items-center">
          <input 
            v-model="userInput" 
